...
## Project Structure
    ...
    ├── withered_leaf_dev_59615  # Django project configurations
...
1. Clone this repo and `cd withered_leaf_dev_59615`
...
2. Clone this repo and `cd withered_leaf_dev_59615`
